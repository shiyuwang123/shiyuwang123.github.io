...
export default function Post() {
  return (
    <PostLayout
      ...
      categories={['Diary']}
    >
      <p>笔记本就是苹果，架构就是arm，台式机就是linux，耳机就是索尼，游戏引擎就是unreal，服务就是谷歌，工具链就是kitware，图形接口就是WebGPU，编程就是cpp，计算就是sycl，存数据就是HDF5，买东西就去拼多多，看书就是zlibrary，吃药就吃阿比特龙，直播就看户晨风，看报就看联合早报，美国总统就选纽森，工作地点就选新加坡。我看最近那，我自己制作我的图片啊，就是周围贴上谷歌，苹果，kitware，户晨风等的标志。那我觉得挺好的，因为你普通人，选这些你是一点坑都没有的，你一定不会吃亏的，如果我给你推荐杂七杂八的选择，你去吃亏了，你不回头骂我是不是。所以生活中一定要找真正好的品牌，真正好的信息渠道。否则你的生活成本不但会高，而且会跟碰到屎一样难受。</p>
      
      <p>If you’re using a laptop, it should be Apple.
      If you are choosing architecture, it should be ARM.
      If you are using a desktop, then Linux.
      For headphones, always Sony.
      For game engines, Unreal.
      For services, Google.
      For toolchains, Kitware.
      For graphics interfaces, WebGPU.
      For programming, cpp.
      For computing, SYCL.
      For data storage, HDF5.
      For shopping, go to Pinduoduo.
      For books, Z-Library.
      For medicine, take Abiraterone.
      For live streams, watch Hu Chenfeng.
